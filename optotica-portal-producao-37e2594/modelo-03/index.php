...
<title>Optótica — Modelo 03</title>
<style>
:root{
  --bg:#f3f3f0;
  --paper:#fff;
...
<div class="shell">
  ...
  <div class="crumb">Catálogo &nbsp;›&nbsp; Armações &nbsp;›&nbsp; Modelo 03</div>

  <main class="product">
    <section class="gallery" aria-label="Fotos da armação">
      <div class="hero">
        <img id="heroImage" referrerpolicy="no-referrer" alt="Modelo 03">
    ...
    <aside class="card">
      ...
      <h1>Modelo 03</h1>
      <p class="kind">Armação hexagonal</p>
      <p class="product-code">Cód. <span id="publicProductCode">M03-PENDENTE-0003</span></p>
      ...
      <div class="measures" aria-label="Medidas principais">
        <div class="measure"><b>51 mm</b><span>largura da lente</span></div>
        <div class="measure"><b>49 mm</b><span>altura da lente</span></div>
      </div>
  ...
  <section class="detailed-measures" aria-labelledby="detailedMeasuresTitle">
    <div class="detailed-measures-head">
      <div>
        ...
        <p>As medidas confirmadas pela API são 51 mm de largura e 49 mm de altura da lente.</p>
      </div>
    </div>

    <div class="measure-image-fallback">
      A imagem técnica de medidas ainda não foi vinculada a este cadastro.<br>
      Medidas confirmadas: 51 mm de largura da lente e 49 mm de altura.
    </div>
  </section>
  ...
  <section class="operator" id="operatorPanel" aria-label="Dados internos">
    ...
    <div class="op-grid">
      <div class="op-item"><span>Cadastro</span><b>OPT-0003</b></div>
      <div class="op-item"><span>Código comercial</span><b id="internalCode">M03-PENDENTE-0003</b></div>
      <div class="op-item"><span>Product ID fornecedor</span><b>1005005643942879</b></div>
      <div class="op-item"><span>SKU selecionado</span><b id="opSku">12000033870107264</b></div>
      <div class="op-item"><span>Cor</span><b id="opColor">Preto</b></div>
      <div class="op-item"><span>Estoque SKU</span><b id="opQty">2097</b></div>
      <div class="op-item"><span>Custo fonte</span><b id="opSourcePrice">US$ 10,05</b></div>
  ...
  <footer><span>Optótica · catálogo de armações</span><span>Modelo 03</span></footer>
</div>
...
<div class="modal" id="modal" role="dialog" aria-modal="true" aria-labelledby="tryTitle">
  <div class="modal-card">
    <div class="modal-top">
      <div><div class="kicker">Prova virtual</div><h2 id="tryTitle">Veja o Modelo 03 em você</h2></div>
...
/*
  ...
  Product ID AliExpress: 1005005643942879
  Cadastro Optótica: OPT-0003
...
const PRODUCT = {
  publicName: 'Modelo 03',
  optoticaId: 'OPT-0003',
  supplierProductId: '1005005643942879',
  registeredCostBRLExact: null,
  registeredFXUSDBRL: null,
  measures: { lensWidth: 51, lensHeight: 49 },
  variants: [
    {
      color:'Tartaruga',
      supplierName:'leopard with clear',
      supplierSku:'12000033870107267',
      qty:3983,
      sourcePromoUSD:10.05,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/S99b763a52c814ce3a7be2e3326ec28aaE.jpg'
    },
    {
      color:'Cinza translúcido',
      supplierName:'grey with clear',
      supplierSku:'12000033870107266',
      qty:2093,
      sourcePromoUSD:10.05,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/Sb21bdb58ce2c495eaa6764f9749a3288p.jpg'
    },
    {
      color:'Verde azulado',
      supplierName:'green blue frame',
      supplierSku:'12000033870107265',
      qty:2096,
      sourcePromoUSD:10.05,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/S8b9f8b6c70f74bbdb15713b018f3f5b6i.jpg'
    },
    {
      color:'Preto',
      supplierName:'black with clear',
      supplierSku:'12000033870107264',
      qty:2097,
      sourcePromoUSD:10.05,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/Sb20cc9d865944c5281778afff10dad88q.jpg'
    },
    {
      color:'Roxo translúcido',
      supplierName:'purple with clear',
      supplierSku:'12000033870107269',
      qty:2097,
      sourcePromoUSD:10.05,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/S55776d43be0a4e2780dc00b7348bb88eq.jpg'
    },
    {
      color:'Roxo e rosa',
      supplierName:'purple pink frame',
      supplierSku:'12000033870107268',
      qty:2097,
      sourcePromoUSD:10.05,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/S44bee26af0724866bdb725424c29748cO.jpg'
    }
  ]
};
