...
<title>Optótica — Modelo 05</title>
<style>
:root{
  --bg:#f3f3f0;
  --paper:#fff;
...
<div class="shell">
  ...
  <div class="crumb">Catálogo &nbsp;›&nbsp; Armações &nbsp;›&nbsp; Modelo 05</div>

  <main class="product">
    <section class="gallery" aria-label="Fotos da armação">
      <div class="hero">
        <img id="heroImage" referrerpolicy="no-referrer" alt="Modelo 05">
    ...
    <aside class="card">
      ...
      <h1>Modelo 05</h1>
      <p class="kind">Armação redonda</p>
      <p class="product-code">Cód. <span id="publicProductCode">M05-PENDENTE-0005</span></p>
  ...
  <section class="operator" id="operatorPanel" aria-label="Dados internos">
    ...
    <div class="op-grid">
      <div class="op-item"><span>Cadastro</span><b>OPT-0005</b></div>
      <div class="op-item"><span>Código comercial</span><b id="internalCode">M05-PENDENTE-0005</b></div>
      <div class="op-item"><span>Product ID fornecedor</span><b>4000115179527</b></div>
      <div class="op-item"><span>SKU selecionado</span><b id="opSku">10000000299787783</b></div>
      <div class="op-item"><span>Cor</span><b id="opColor">Preto</b></div>
      <div class="op-item"><span>Estoque SKU</span><b id="opQty">156</b></div>
      <div class="op-item"><span>Custo fonte</span><b id="opSourcePrice">US$ 6,97</b></div>
  ...
  <footer><span>Optótica · catálogo de armações</span><span>Modelo 05</span></footer>
</div>
...
<div class="modal" id="modal" role="dialog" aria-modal="true" aria-labelledby="tryTitle">
  <div class="modal-card">
    <div class="modal-top">
      <div><div class="kicker">Prova virtual</div><h2 id="tryTitle">Veja o Modelo 05 em você</h2></div>
...
/*
  ...
  Product ID AliExpress: 4000115179527
  Cadastro Optótica: OPT-0005
...
const PRODUCT = {
  publicName: 'Modelo 05',
  optoticaId: 'OPT-0005',
  supplierProductId: '4000115179527',
  ...
  variants: [
    {
      color:'Rosé',
      supplierName:'rose gold',
      supplierSku:'12000041478496910',
      qty:356,
      sourcePromoUSD:6.97,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/Sc62af7f0abbc4490ba3a350fe968739aY.jpg'
    },
    {
      color:'Prata',
      supplierName:'silver',
      supplierSku:'10000000299787786',
      qty:189,
      sourcePromoUSD:6.97,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/Sf947e14a82ca4ede8ba0ac0c00fbab3bo.jpg'
    },
    {
      color:'Dourado',
      supplierName:'gold',
      supplierSku:'10000000299787784',
      qty:217,
      sourcePromoUSD:6.97,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/Scc895228b913488caf0de0922fd8b1f8n.jpg'
    },
    {
      color:'Preto',
      supplierName:'black',
      supplierSku:'10000000299787783',
      qty:156,
      sourcePromoUSD:6.97,
      image:'https://ae-pic-a1.aliexpress-media.com/kf/Saaf42d4c90a748169feec44ee43b5a27P.jpg'
    }
  ]
};
