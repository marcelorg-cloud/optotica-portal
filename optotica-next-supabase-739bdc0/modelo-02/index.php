...
<title>Optótica — Modelo 02</title>
<style>
:root{
  --bg:#f3f3f0;
  --paper:#fff;
...
<div class="shell">
  ...
  <div class="crumb">Catálogo &nbsp;›&nbsp; Armações &nbsp;›&nbsp; Modelo 02</div>

  <main class="product">
    <section class="gallery" aria-label="Fotos da armação">
      <div class="hero">
        <img id="heroImage" referrerpolicy="no-referrer" alt="Modelo 02">
    ...
    <aside class="card">
      ...
      <h1>Modelo 02</h1>
      <p class="kind">Armação retangular</p>
      <p class="product-code">Cód. <span id="publicProductCode">M02-PENDENTE-0002</span></p>
      ...
      <section class="section">
        <div class="section-title">
          <h2>Escolha a cor</h2>
          <span id="selectedColor">Verde oliva</span>
        </div>
      ...
      <div class="measures" aria-label="Medidas principais">
        ...
        <div class="measure"><b>43 mm</b><span>altura da lente</span></div>
      </div>
  ...
  <section class="detailed-measures" aria-labelledby="detailedMeasuresTitle">
    <div class="detailed-measures-head">
      <div>
        ...
        <p>As medidas confirmadas pela API são 50 mm de largura e 43 mm de altura da lente.</p>
      </div>
    </div>

    <div class="measure-image-fallback">
      A imagem técnica de medidas ainda não foi vinculada a este cadastro.<br>
      Medidas confirmadas: 50 mm de largura da lente e 43 mm de altura.
    </div>
  </section>
  ...
  <section class="operator" id="operatorPanel" aria-label="Dados internos">
    ...
    <div class="op-grid">
      <div class="op-item"><span>Cadastro</span><b>OPT-0002</b></div>
      <div class="op-item"><span>Código comercial</span><b id="internalCode">M02-PENDENTE-0002</b></div>
      <div class="op-item"><span>Product ID fornecedor</span><b>1005006235178892</b></div>
      <div class="op-item"><span>SKU selecionado</span><b id="opSku">12000036418827724</b></div>
      <div class="op-item"><span>Cor</span><b id="opColor">Verde oliva</b></div>
      <div class="op-item"><span>Estoque SKU</span><b id="opQty">1</b></div>
      <div class="op-item"><span>Custo fonte</span><b id="opSourcePrice">US$ 9,33</b></div>
  ...
  <footer><span>Optótica · catálogo de armações</span><span>Modelo 02</span></footer>
</div>
...
<div class="modal" id="modal" role="dialog" aria-modal="true" aria-labelledby="tryTitle">
  <div class="modal-card">
    <div class="modal-top">
      <div><div class="kicker">Prova virtual</div><h2 id="tryTitle">Veja o Modelo 02 em você</h2></div>
...
/*
  ...
  Product ID AliExpress: 1005006235178892
  Cadastro Optótica: OPT-0002
...
const PRODUCT = {
  publicName: 'Modelo 02',
  optoticaId: 'OPT-0002',
  supplierProductId: '1005006235178892',
  registeredCostBRLExact: null,
  registeredFXUSDBRL: null,
  measures: { lensWidth: 50, lensHeight: 43 },
  variants: [
    {
      color:'Cinza translúcido',
      supplierName:'grey with clear',
      supplierSku:'12000036418827723',
      qty:2,
      sourcePromoUSD:9.26,
      image:'https://ae01.alicdn.com/kf/S5f33a8d4b8144b6ab891ce6e5fbae253O.jpg'
    },
    {
      color:'Azul translúcido',
      supplierName:'blue with clear',
      supplierSku:'12000036418827722',
      qty:2,
      sourcePromoUSD:9.26,
      image:'https://ae01.alicdn.com/kf/S7cc8227388c645bab762c276c601eff4t.jpg'
    },
    {
      color:'Preto',
      supplierName:'black with clear',
      supplierSku:'12000036418827721',
      qty:1,
      sourcePromoUSD:9.26,
      image:'https://ae01.alicdn.com/kf/Sd57ab24d124241d4b5bdd69ab357f8aeM.jpg'
    },
    {
      color:'Tartaruga preta',
      supplierName:'black leopard frame',
      supplierSku:'12000036418827720',
      qty:1,
      sourcePromoUSD:8.77,
      image:'https://ae01.alicdn.com/kf/S6acd6072ae3942b99a348ae43bfdca8cC.jpg'
    },
    {
      color:'Verde oliva',
      supplierName:'olive green frame',
      supplierSku:'12000036418827724',
      qty:1,
      sourcePromoUSD:9.33,
      image:'https://ae01.alicdn.com/kf/Sa9d95929bc2d4779b87e36b11a907778X.jpg'
    },
    {
      color:'Preto translúcido',
      supplierName:'black clear frame',
      supplierSku:'12000036418827719',
      qty:2,
      sourcePromoUSD:8.95,
      image:'https://ae01.alicdn.com/kf/S8475ae90b1fe46ec915c1bea7bfcaa56w.jpg'
    }
  ]
};
