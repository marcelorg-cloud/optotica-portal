...
<title>Optótica — Modelo 01</title>
<style>
:root{
  --bg:#f3f3f0;
  --paper:#fff;
...
<div class="shell">
  ...
  <div class="crumb">Catálogo &nbsp;›&nbsp; Armações &nbsp;›&nbsp; Modelo 01</div>

  <main class="product">
    <section class="gallery" aria-label="Fotos da armação">
      <div class="hero">
        <img id="heroImage" referrerpolicy="no-referrer" alt="Modelo 01">
    ...
    <aside class="card">
      ...
      <p class="product-code">Cód. <span id="publicProductCode">M01-14060-0001</span></p>
      ...
      <section class="section">
        <div class="section-title">
          <h2>Escolha a cor</h2>
          <span id="selectedColor">Preto</span>
        </div>
      ...
      <div class="measures" aria-label="Medidas principais">
        <div class="measure"><b>50 mm</b><span>largura da lente</span></div>
        <div class="measure"><b>36 mm</b><span>altura da lente</span></div>
      </div>
  ...
  <section class="detailed-measures" aria-labelledby="detailedMeasuresTitle">
    <div class="detailed-measures-head">
      <div>
        ...
        <p>Imagem técnica do produto original. As medidas principais confirmadas pela API são 50 mm de largura e 36 mm de altura da lente.</p>
      </div>
    </div>

    <img class="measure-source-image" id="measureSourceImage" referrerpolicy="no-referrer" loading="lazy"
      src="https://ae-pic-a1.aliexpress-media.com/kf/S1fadd9ed37784feda5fe5a3bd9db2f67I.jpg"
      alt="Medidas detalhadas do Modelo 01 em milímetros"
      style="width:100%;max-width:920px;margin:0 auto;display:block;border-radius:16px;background:#fff;object-fit:contain"
      onerror="this.style.display='none';document.getElementById('measureImageFallback').style.display='block'">
    <div class="measure-image-fallback" id="measureImageFallback" style="display:none">
      A imagem técnica não pôde ser carregada. As medidas confirmadas são 50 mm de largura da lente e 36 mm de altura.
    </div>
  </section>
  ...
  <section class="operator" id="operatorPanel" aria-label="Dados internos">
    ...
    <div class="op-grid">
      <div class="op-item"><span>Cadastro</span><b>OPT-0001</b></div>
      <div class="op-item"><span>Código comercial</span><b id="internalCode">M01-14060-0001</b></div>
      <div class="op-item"><span>Product ID fornecedor</span><b>1005012995462441</b></div>
      <div class="op-item"><span>SKU selecionado</span><b id="opSku">12000059988264098</b></div>
      <div class="op-item"><span>Cor</span><b id="opColor">Preto</b></div>
      <div class="op-item"><span>Estoque SKU</span><b id="opQty">4</b></div>
      <div class="op-item"><span>Custo fonte</span><b id="opSourcePrice">US$ 9,04</b></div>
  ...
  <footer><span>Optótica · catálogo de armações</span><span>Modelo 01</span></footer>
</div>
...
<div class="modal" id="modal" role="dialog" aria-modal="true" aria-labelledby="tryTitle">
  <div class="modal-card">
    <div class="modal-top">
      <div><div class="kicker">Prova virtual</div><h2 id="tryTitle">Veja o Modelo 01 em você</h2></div>
...
/*
  ...
  Product ID AliExpress: 1005012995462441
  Cadastro Optótica: OPT-0001
...
const PRODUCT = {
  publicName: 'Modelo 01',
  optoticaId: 'OPT-0001',
  supplierProductId: '1005012995462441',
  registeredCostBRLExact: 46.8661,
  registeredFXUSDBRL: 5.1843,
  measures: { lensWidth: 50, lensHeight: 36 },
  variants: [
    {color:'Cinza', supplierName:'grey with clear', supplierSku:'12000059988264101', qty:4, sourcePromoUSD:9.04, image:'https://ae01.alicdn.com/kf/S31ef450c413c4dd8bfcdf84abf3f463fv.jpg'},
    {color:'Marrom escuro', supplierName:'dark brown frame', supplierSku:'12000059988264100', qty:4, sourcePromoUSD:9.04, image:'https://ae01.alicdn.com/kf/S0fef54c8c319465383c13ffb7ab97a25y.jpg'},
    {color:'Tartaruga', supplierName:'leopard with clear', supplierSku:'12000059988264103', qty:4, sourcePromoUSD:9.04, image:'https://ae01.alicdn.com/kf/S6ed23163211949cba992171950e76a4ec.jpg'},
    {color:'Verde', supplierName:'green with clear', supplierSku:'12000059988264102', qty:4, sourcePromoUSD:9.04, image:'https://ae01.alicdn.com/kf/S084ca5e6994f47a18a072141562a3289m.jpg'},
    {color:'Marrom', supplierName:'brown with clear', supplierSku:'12000059988264099', qty:4, sourcePromoUSD:9.04, image:'https://ae01.alicdn.com/kf/Sc14111ea1cc546419d84a328352a4e8cn.jpg'},
    {color:'Preto', supplierName:'black with clear', supplierSku:'12000059988264098', qty:4, sourcePromoUSD:9.04, image:'https://ae01.alicdn.com/kf/S24493ae994b64affa0aeab8dc510e432L.jpg'}
  ]
};
