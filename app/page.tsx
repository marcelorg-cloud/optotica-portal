  ...
  return (
    <div className="page-shell">
      ...
      <section className="feature-grid" aria-label="Recursos">
        <article><span>01</span><h2>Dados organizados</h2><p>Pacientes, receitas e pedidos vinculados à empresa correta.</p></article>
        <article><span>02</span><h2>Acesso controlado</h2><p>Permissões por empresa, unidade, profissional e paciente.</p></article>
